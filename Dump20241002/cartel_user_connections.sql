...
CREATE TABLE `user_connections` (
  ...
  KEY `FKs65m60yfjlj2plyjpbge2i0ou` (`connection_id`),
  KEY `FK3yvohvstyav0ifob852rlnecu` (`user_id`),
  CONSTRAINT `FK3yvohvstyav0ifob852rlnecu` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
  CONSTRAINT `FKs65m60yfjlj2plyjpbge2i0ou` FOREIGN KEY (`connection_id`) REFERENCES `user` (`user_id`)
...
INSERT INTO `user_connections` VALUES (20,63),(20,64),(20,65);
